...
public class PostController {
	...
	public Post read(@PathVariable(value="id") long id) throws PostNotFoundException {
		...
		if( post == null ){
			// handling exception for /posts/767 or any other posts which is not available
	...
	//handling the exception using @exceptionHandler annotation
	...
	public void handlePostNotFound(PostNotFoundException exception, HttpServletResponse response) throws IOException{
		...
		//returns 404 error code as well as error message
	}
}
