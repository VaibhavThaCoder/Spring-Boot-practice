...
public class CustomErrorController implements ErrorController {
	//implementing ErrorController to customize default /error path
	...
	// overriding the error path by overriding the getErrorPath method.
	@Override
	...
	//this will look for 404.hmtl page in /templates and will redirect us to show that page
	@RequestMapping("/404")
